...
export default function CharacterInfo(props) {
    ...
    return html`
        ...
        <div class=section-title><a style='color: white; text-decoration: underline;' href='#database/expressions/?${props.currentCharacter.hanzi}'>Expressions</a></div>
        <ul style='background-color: transparent; padding: 0; margin-top: 0; margin-bottom: 0;' class='section-content expandable'>
            ...
            <li style='display: flex; gap: 0.2em; margin: 0; padding: 0;'>
                ...
                <a style='color: white; white-space: nowrap;' href='#' onclick=${ev => { ev.preventDefault(); setSelectedShortInfo(e); }}>${e.hanzi}</a>
        ...
        <div class=section-content>
            ...
            <a style='color: white;' href='#' onclick=${ev => { ev.preventDefault(); setSelectedShortInfo(c); }}>${c.hanzi}</a>
            `) : '(none yet)'}
        </div>
