...
export default function Flashcard({ user }) {
    ...
    const flipCard = () => window.location.hash = makeHash(selectedDeck, hanzi, flipped ? '' : '/flipped')
    ...
    return html`
        ...
        <div class='card ${flipped}' onclick=${flipCard} style='display: flex; flex-direction: column; width: 100%; aspect-ratio: 2 / 3; border-radius: .4em; box-shadow: 0 25px 50px -12px rgb(0 0 0 / .25); background: linear-gradient(to bottom right, #7EA5C5 30%, #486A8D 100%);'>
